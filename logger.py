...
class Logger(object):
    def __init__(self, log_dir, use_tb, use_wandb, mode=None):
        ...
        self._train_mg = MetersGroup(log_dir / 'train.csv',
                                     ...
                                     use_wandb=use_wandb)
        if mode is None:
            self._valid_mg = MetersGroup(log_dir / 'valid.csv',
    ...
    def log(self, key, value, step):
        assert key.startswith('train') or key.startswith('eval') or key.startswith('valid')
    ...
    def dump(self, step, ty=None):
        ...
        if ty is None or ty =='valid':
            self._valid_mg.dump(step, 'valid')
